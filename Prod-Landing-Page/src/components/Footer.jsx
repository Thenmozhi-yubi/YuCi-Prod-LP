      ...
      <div className="container mx-auto max-w-4xl px-4">
        <div className="grid grid-cols-1 sm:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            ...
            {content && <p className="text-center sm:text- text-content">{content}</p>}
            ...
            <div className="mt-6 text-center sm:text-left flex gap-3">
              {buttons?.map((button, index) => (
                <a
                  key={index}
                  href={button.link}
                  className="bg-primary text-white px-2 text-center py-1 rounded-full block mb-2 text-sm sm:inline-block"
                >
                  {button.text}
                </a>
              ))}
          ...
          <div className="col-span-1">
            ...
            <ul className="text- text-content">
          ...
          {/* Third Column - Company and Resources */}
          <div className="col-span-1">
            ...
            {resources?.title && (
              <>
                <h3 className="text-lg font-semibold mt-6 mb-2">{resources.title}</h3>
                <ul className="text-sm text-content">
          ...
          {/* Fourth Column - Security and Help */}
          <div className="col-span-1">
            {security?.title && (
              <>
